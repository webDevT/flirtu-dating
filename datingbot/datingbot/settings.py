...
SECRET_KEY = 'o+8bd)w_aym01)e42j&b7w6vz$yu54a@fe+zo$tjy9-u1=w6mf'
...
WSGI_APPLICATION = 'datingbot.wsgi.application'
...
LOCALE_PATHS = [os.path.join(BASE_DIR, 't.locale')]
...
# MEDIA_ROOT = '/home/ubuntu/flirtu-dev/media'
print BASE_DIR
